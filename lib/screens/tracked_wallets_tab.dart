    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setStateDialog) => AlertDialog(
          ...
          title: Row(children: [Icon(PhosphorIcons.listPlusFill, color: Theme.of(context).primaryColor), const SizedBox(width: 8), Text('Bulk Import', style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 16))]),
          content: SizedBox(
            width: double.maxFinite,
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text('Duplicates are safely ignored.', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 11)),
                          ...
                          child: Column(
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(hintText: 'Label (e.g. Whale 1)', hintStyle: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant), isDense: true, border: InputBorder.none),
                                    ),
                                  ),
                                  if (index > 0)
                                    IconButton(
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(hintText: 'Solana Address', hintStyle: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant), isDense: true, border: InputBorder.none),
                              ),
                            ],
                          ),
                        ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: isSaving ? const SizedBox(width: 16, height: 16, child: CircularProgressIndicator(color: Colors.white)) : const Text('Import All'),
            ),
          ],
        ),
      ),
  ...
  Future<void> _showEditModal(dynamic w) async {
    ...
    await showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setStateDialog) => AlertDialog(
          backgroundColor: Theme.of(context).colorScheme.surface,
          title: Row(children: [Icon(PhosphorIcons.pencilSimpleFill, color: Theme.of(context).primaryColor), const SizedBox(width: 8), Text('Edit Tracker', style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 16))]),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(controller: lblCtrl, style: TextStyle(color: Theme.of(context).colorScheme.onSurface), decoration: InputDecoration(labelText: 'Label', filled: true, fillColor: Theme.of(context).colorScheme.onSurface.withOpacity(0.05), border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none))),
              const SizedBox(height: 12),
              TextField(controller: addrCtrl, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 12), decoration: InputDecoration(labelText: 'Address', filled: true, fillColor: Theme.of(context).colorScheme.onSurface.withOpacity(0.05), border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none))),
            ],
          ),
          actions: [
            TextButton(onPressed: () => Navigator.pop(ctx), child: Text('Cancel', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant))),
  ...
  Future<void> _showDeleteModal(int id) async {
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: Theme.of(context).colorScheme.surface,
        title: Row(children: [const Icon(PhosphorIcons.warningCircleFill, color: Colors.redAccent), const SizedBox(width: 8), Text('Remove Tracker?', style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 16))]),
        content: Text('Are you sure you want to stop tracking this wallet? You must sync the webhook afterward.', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 13)),
        actions: [
          ...
          ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.redAccent, foregroundColor: Colors.white), onPressed: () => Navigator.pop(ctx, true), child: const Text('Remove')),
        ],
      ),
    );
      ...
      child: ListView(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Wallet Label', labelStyle: TextStyle(color: theme.colorScheme.onSurfaceVariant), filled: true, fillColor: theme.colorScheme.onSurface.withOpacity(0.05), border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none)),
                ),
                const SizedBox(height: 12),
                TextField(
                  controller: _walletController,
                  style: TextStyle(color: theme.colorScheme.onSurface, fontFamily: 'monospace', fontSize: 12),
                  decoration: InputDecoration(labelText: 'Solana Address', labelStyle: TextStyle(color: theme.colorScheme.onSurfaceVariant), filled: true, fillColor: theme.colorScheme.onSurface.withOpacity(0.05), border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none)),
                ),
                const SizedBox(height: 16),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('ACTIVE TRACKERS', style: TextStyle(color: theme.colorScheme.onSurface, fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 1)),
              OutlinedButton.icon(
              ...
              child: GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Row(
                            children: [
                              Flexible(child: Text(w['label'] ?? 'Unknown', style: TextStyle(color: theme.colorScheme.onSurface, fontWeight: FontWeight.bold, fontSize: 14), overflow: TextOverflow.ellipsis)),
                    ...
                    Text(w['address'] ?? '', style: TextStyle(color: theme.colorScheme.onSurfaceVariant, fontFamily: 'monospace', fontSize: 11)),
                    const SizedBox(height: 12),
                    ...
                    Wrap(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: (w['copy_enabled'] == true || w['copy_enabled'] == 1) ? Colors.greenAccent.withOpacity(0.1) : theme.colorScheme.onSurface.withOpacity(0.05),
                              border: Border.all(color: (w['copy_enabled'] == true || w['copy_enabled'] == 1) ? Colors.greenAccent.withOpacity(0.3) : theme.colorScheme.onSurface.withOpacity(0.1)),
                              borderRadius: BorderRadius.circular(6),
                            ),
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(PhosphorIcons.copy, color: (w['copy_enabled'] == true || w['copy_enabled'] == 1) ? Colors.greenAccent : theme.colorScheme.onSurfaceVariant, size: 14),
                                const SizedBox(width: 6),
                                Text((w['copy_enabled'] == true || w['copy_enabled'] == 1) ? 'Copying' : 'Paused', style: TextStyle(color: (w['copy_enabled'] == true || w['copy_enabled'] == 1) ? Colors.greenAccent : theme.colorScheme.onSurfaceVariant, fontSize: 11, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
                            decoration: BoxDecoration(color: theme.colorScheme.onSurface.withOpacity(0.05), border: Border.all(color: theme.colorScheme.onSurface.withOpacity(0.1)), borderRadius: BorderRadius.circular(6)),
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(PhosphorIcons.pencilSimple, color: theme.colorScheme.onSurface, size: 14),
                                const SizedBox(width: 6),
                                Text('Edit', style: TextStyle(color: theme.colorScheme.onSurface, fontSize: 11, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ),
